...
function mysql_field_def(f: PMYSQL_FIELD): PAnsiChar;
...
var
  ...
  g_libmysql_ClientVersion: longword; //added by huz
...
begin
  ...
  then
    ...
    g_libmysql_ClientVersion := internal_libmysql_ClientVersion; //added by huz
    _mysql_get_server_version := GetProcAddress(libmysql_handle, 'mysql_get_server_version');
    if (_mysql_get_server_version=nil)
    then
      _mysql_get_server_version := @libmysql_ServerVersion_substitute;
